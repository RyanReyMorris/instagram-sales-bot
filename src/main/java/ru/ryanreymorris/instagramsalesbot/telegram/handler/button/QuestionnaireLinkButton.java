...
@Component
public class QuestionnaireLinkButton implements Button {

    private final static String QUESTIONNAIRE_LINK = "Приложите ссылку на анкету";
    ...
    public void handleClick(Update update) {
        ...
        SendMessage sendMessage = replyMessagesService.createMessage(QUESTIONNAIRE_LINK, botUser.getTgUserId());
    ...
    public ButtonEnum getButton() {
        return ButtonEnum.QUESTIONNAIRE_LINK;
    }
}