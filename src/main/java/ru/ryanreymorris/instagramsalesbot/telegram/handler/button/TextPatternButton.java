...
@Component
public class TextPatternButton implements Button {

    private final static String TEXT_MATCHER = "Введите ключевое слово, по которому необходимо искать комментарии";
    ...
    public void handleClick(Update update) {
        ...
        SendMessage sendMessage = replyMessagesService.createMessage(TEXT_MATCHER, botUser.getTgUserId());
    ...
    public ButtonEnum getButton() {
        return ButtonEnum.TEXT_PATTERN;
    }
}
