package ru.ryanreymorris.instagramsalesbot.telegram.handler.video;
...
@Component
public class VideoHandler implements UpdateHandler {
    ...
    public void handle(Update update) {
        ...
        switch (botUser.getActiveButton()) {
            case MASS_SENDING -> {
                SendVideo sendVideo = new SendVideo("", new InputFile(update.getMessage().getVideo().getFileId()));
                massSendingStorage.setMethod(sendVideo);
