package ru.ryanreymorris.instagramsalesbot.telegram.handler.videonote;
...
@Component
public class VideoNoteHandler implements UpdateHandler {
    ...
    public void handle(Update update) {
        ...
        switch (botUser.getActiveButton()) {
            case MASS_SENDING -> {
                SendVideoNote sendVideoNote = new SendVideoNote("", new InputFile(update.getMessage().getVideoNote().getFileId()));
                massSendingStorage.setMethod(sendVideoNote);
