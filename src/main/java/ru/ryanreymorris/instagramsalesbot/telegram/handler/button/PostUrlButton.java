...
@Component
public class PostUrlButton implements Button {

    private final static String POST_URL = "Приложите ссылку на пост, по которому необходимо искать пользователей";
    ...
    public void handleClick(Update update) {
        ...
        SendMessage sendMessage = replyMessagesService.createMessage(POST_URL, botUser.getTgUserId());
