...
@Component
public class LessonLinkButton implements Button {

    private final static String LESSON_LINK = "Приложите ссылку на видеоурок";
    ...
    public void handleClick(Update update) {
        ...
        SendMessage sendMessage = replyMessagesService.createMessage(LESSON_LINK, botUser.getTgUserId());
